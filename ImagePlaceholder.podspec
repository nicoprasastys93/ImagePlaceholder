Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Nico Prasasty S"
  # spec.authors            = { "Nico Prasasty S" => "nicoprasastysembiring@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Nico Prasasty S"
  ...
  spec.source       = { :git => "http://EXAMPLE/ImagePlaceholder.git", :tag => "#{spec.version}" }
